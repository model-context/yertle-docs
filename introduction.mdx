...
<CardGroup cols={2}>
  ...
  <Card title="Authentication" icon="key" href="/authentication">
    Learn how to authenticate API requests with Personal Access Tokens.
  </Card>
...
The Yertle CLI is open source on GitHub:

- [model-context/yertle-python](https://github.com/model-context/yertle-python) — Python SDK and CLI (`uv tool install yertle`)
